...
2. Du hast bereits [einen Sensor vom Type HTTP angelegt](/docs/sensors)
3. Du hast [einen Token erstellt](/docs/tokens) und dir sicher gespeichert
...
Damit sind die Vorbereitungen abgesclossen. Nun folgt die eigentliche Anfrage mit der `requests`-Bibliothek. Füge die folgenden Zeilen an dein Skript an.
