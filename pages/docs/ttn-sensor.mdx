...
metaDescription: 'Folge dieser einfachen Schritt-für-Schritt-Anleitung, um einen neuen TTN-Sensoren auf Stadtpuls hinzuzufügen.'
---
...
Du hast bereits eigene Sensoren bei <a href="https://www.thethingsnetwork.org/" target="_blank">The Things Network</a>? Fantastisch!
In dieser Sektion erklären wir wie du deinem Account Leben einhauchen und deine TTN-Sensoren in nur wenigen Minuten zu *Stadtpuls* hinzufügen kannst. 
...
Um deine TTN-Sensoren mit *Stadtpuls* erfolgreich verknüpfen zu können ist es wichtig, dass du e als **Device-ID** die exakt gleiche Device-ID aus deiner TTN-Applikation nutzt.
Diese Device-ID findest du <a href="https://www.thethingsnetwork.org/" target="_blank">The Things Network</a>, nicht auf *Stadtpuls*.
...
Damit Dein TTN-Sensor mit jedem Messwert automatischeinen POST-Request and unser *Stadtpuls* API stellt und die Sensormesswerte in unserer Datenbank ankommen, musst nun noch der **TTN-Webhook** eingerichtet werden.
...
Navigiere zu einem Stadtpuls-Account, klicke auf **Tokens** und erstelle dire einen neuen Token für deinen Sensor.
...
Füge diesen Token mit dem Zusatz `Bearer ` in das Eingabefeld. Solltest du deinen Token verloren haben, kannst du dir in deinem Account einen neuen Token generieren lassen. 
...
Damit sollten künftig alle Messwerte deines Sensors auf *Stadtpul* sichtbar sein.
