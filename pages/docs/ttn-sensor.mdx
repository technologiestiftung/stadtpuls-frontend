...
Wir übergeben der API jedoch noch eine zusätzliche Information – **Additional headers** mit dem Namen *authorization* im Header: nämlich deinen Authorisierungs-Token, den du dir bereits angelegt hast.
